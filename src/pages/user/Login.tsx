...
const Login = () => {
	...
	return (
		<div className='w-full max-w-[2560px] mx-auto h-screen overflow-hidden justify-center flex bg-black items-center'>
			<form
				className='w-max mx-auto sm:w-4/5 lg:w-1/2 lg:mx-0 bg-red px-[20px] md:px-[40px] lg:px-[60px] xl:px-[80px]'
				...
				<div className=' mt-[60px] lg:mt-[40px] xl:mt-[60px]   w-full md:w-4/5 max-w-[420px]  mx-auto lg:mx-0'>
				...
				<div className='mt-[20px] w-full md:w-4/5 max-w-[420px] mx-auto lg:mx-0 '>
				...
				<button
					type='submit'
					className=' mt-[30px] block text-[18px] font-medium bg-white rounded-[32px] w-full md:w-4/5 max-w-[420px] mx-auto lg:mx-0 text-center p-[16px] md:p-[20px]'>
					Login
				</button>
			...
			<div className='hidden lg:block relative w-1/2 rounded-[18px] overflow-hidden bg-cover bg-center bg-[url("/login-cover.jpg")] form-image'>
